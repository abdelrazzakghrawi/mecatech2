...
const PrestationModel = ({ onClose }) => {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-10 z-50">
            <div className="bg-white  max-w-4xl mt-8  p-8 rounded-lg shadow-lg relative h-screen overflow-y-auto"> {/* Added h-screen and overflow-y-auto */}
                                ...
                                <div className="mt-4">
                                    {prestations[category].map((prestation, prestationIndex) => (
                                        <div key={prestationIndex} className="flex items-center">
                                            <input type="checkbox" id={prestation} className="mr-2" />
